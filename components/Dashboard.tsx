...
// Helper to check if a date string 'yyyy-mm-dd' was yesterday
const isYesterday = (dateStr: string): boolean => {
    ...
    checkDate.setHours(0, 0, 0, 0); // Normalize checkDate
...
const DailyFiveModal: React.FC<{ onClose: () => void; onComplete: () => void }> = ({ onClose, onComplete }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fade-in">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-2xl">
                <h2 className="text-2xl font-bold mb-4">The Daily 5 - Question {currentQuestionIndex + 1}/5</h2>
...
const Dashboard: React.FC<{ setActiveView: Dispatch<SetStateAction<View>> }> = ({ setActiveView }) => {
    ...
    return (
        <div className="space-y-8">
            <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-100 animate-fade-in">Hey {userProfile?.name}, ready to learn?</h1>
